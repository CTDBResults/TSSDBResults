   ...
   PageFactory.initElements(driver, LandingPage.class).hitEnter();
	...
	public void i_click_on(String arg1) throws Throwable {
		...
		if(arg1.equals("Current_Bill")
				...
				||arg1.equals("Edit")
				||arg1.equals("Delete")
				||arg1.equals("FeedbackMsgText")
				||arg1.equals("PageText_TextCode")
				||arg1.equals("PageText_IsVisible")
				||arg1.equals("wt90")
				||arg1.equals("wt46")
				||arg1.equals("wt41")
				||arg1.equals("wt31")
				||arg1.equals("wt30")
				||arg1.equals("wt21")
				||arg1.equals("wt20") //placeholders until christian gasparri fixes them
				||arg1.equals("wt17")
				||arg1.equals("wt16")
				||arg1.equals("wt13")
				||arg1.equals("Next")
				...
				||arg1.equals("AddNew")  
				||arg1.equals("Confirm") 
				||arg1.equals("Continue") 
				||arg1.equals("Submit") 
				||arg1.equals("Search") 
				||arg1.equals("SearchBt") 
				||arg1.equals("Cancel")){
			Thread.sleep(3000);
			DBUtilities createXpath = new DBUtilities(driver);
			String myxpath2 = createXpath.xpathMakerById(arg1);
			System.out.println("Attempting to click on " +myxpath2);
			Assert.assertTrue(" Verification failed as " +myxpath2 +" was NOT FOUND",driver.findElement(By.xpath(myxpath2)).isDisplayed());
		...
		else if (arg1.equals("fa fa-fw fa-question-circle fa-lg")){

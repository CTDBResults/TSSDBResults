	...
	public void checkElementPresentOnScreen(DataTable table) throws InterruptedException
	{
		...
		for (int i = 1; i <data.size(); i++){
			...
			if(name.equals("Current_Bill")
				...
				System.out.println("Checking that element" +myxpath + "is displayed successfully");
				Assert.assertTrue(" Verification failed as " +myxpath +" was NOT FOUND",driver.findElement(By.xpath(myxpath)).isDisplayed());
			...
			}else if(name.equals("Due Date")||name.equals("Account Total")||name.equals("HintInfoIcon")){
...
//				String myxpath = createXpath.xpathMakerBySpanID(name);
				...
				System.out.println("Attempting to click on: " +myxpath);
				Assert.assertTrue("Verification Failed as" +myxpath +"NOT FOUND",driver.findElement(By.xpath(myxpath)).isDisplayed());
